    ...
    serialPort(new QSerialPort)
{
    ...
    connect(readTimer, &QTimer::timeout, this, &YmodemFileTransmit::readTimeOut);
    connect(writeTimer, &QTimer::timeout, this, &YmodemFileTransmit::writeTimeOut);
}
    ...
    switch(status)
    {
        case StatusEstablish:
        {
            if(file->open(QFile::ReadOnly) == true)
            {
                ...
                *len = YMODEM_PACKET_SIZE;
                ...
                emit transmitStatus(StatusEstablish);
        ...
        case StatusTransmit:
        {
            if(fileSize != fileCount)
            {
                ...
                emit transmitStatus(StatusTransmit);
